...
@section('content')
    ...
    <div class="">
                            ...
                            <div class="row d-flex align-items-center">
                                <div class="col-md-6">
                                    <div class="banner-content">
                                        ...
                                        <a href="#"
                                           class="btn btn-medium btn-dark text-uppercase
                                           hover-btn">Shop
                                            Product</a>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="banner-content">
                                        <h1 class="display-2 text-uppercase text-dark pb-5">
                                            Technology Hack You Won't Get</h1>
                                        <a href="#"
                                           class="btn btn-medium btn-dark text-uppercase">Shop
                                            Product</a>
                                    </div>
                                </div>
                                <div class="col-md-5">
        ...
        <section id="mobile-products"
                 class="container product-store position-relative padding-large no-padding-top">
            <div class="container">
                <div class="row">
                    <div class="display-header d-flex justify-content-between pb-3">
                        <h2 class="display-7 text-dark text-uppercase">Mobile Products</h2>
                        <div class="btn-right">
                            <a href="#" class="btn btn-medium btn-normal text-uppercase">Go to
                                Shop</a>
                        </div>
                    </div>
        ...
        <section id="smart-watches" class="container product-store padding-large position-relative">
            <div class="container">
                <div class="row">
                    <div class="display-header d-flex justify-content-between pb-3">
            ...
            <div class="row d-flex flex-wrap align-items-center">
                <div class="col-md-6 col-sm-12">
                    <div class="text-content offset-4 padding-medium">
                        ...
                        <a href="#" class="btn btn-medium btn-dark text-uppercase hover-btn">Shop
                            Sale</a>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="display-header d-flex justify-content-between pb-3">
                        ...
                        <div class="btn-right">
                            <a href="#" class="btn btn-medium btn-normal text-uppercase">Read
                                Blog</a>
                        </div>
                    </div>
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide text-center d-flex justify-content-center">
                                    <div class="review-item col-md-10">
                                        ...
                                        <blockquote>“Tempus oncu enim pellen tesque este pretium in
                                            neque, elit morbi sagittis lorem habi mattis Pellen
                                            tesque pretium feugiat vel morbi suspen dise sagittis
                                ...
                                <div class="swiper-slide text-center d-flex justify-content-center">
                                    <div class="review-item col-md-10">
                                        <i class="icon icon-review"></i>
                                        <blockquote>“A blog is a digital publication that can
                                            complement a website or exist independently. A blog may
        ...
        <section id="subscribe" class="container-fluid padding-large overflow-hidden">
            <div class="">
                <div class="row">
                    <div class="subscribe-content bg-dark d-flex flex-wrap
                    justify-content-center
                     align-items-center padding-medium">
                        <div class="col-md-6 col-sm-12">
                            <div class="display-header pe-3">
                                <h2 class="display-7 text-uppercase text-light">Subscribe To
                                    Our Newsletter</h2>
                            ...
                            <form class="subscription-form validate">
                                <div class="input-group flex-wrap">
                                    <input class="form-control btn-rounded-none" type="email"
                                           name="EMAIL" placeholder="Your email address here"
                                           required="">
                                    <button
                                        class="btn btn-medium btn-accent text-uppercase btn-rounded-none"
        ...
        {{-- <section id="instagram" class="container padding-large overflow-hidden no-padding-top">
             <div class="">
                 <div class="row">
